          ...
          <Fragment>
            <Table basic celled selectable compact="very" sortable>
              <Table.Header>
                <Table.Row>
                  <Table.HeaderCell
                    sorted={column === 'groupId' ? direction : null}
                    onClick={this.sortHandler('groupId')}
                  >
                  ...
                  <Table.HeaderCell
                    ...
                    onClick={this.sortHandler('lastName')}
                  >
                  ...
                  <Table.HeaderCell
                    sorted={column === 'registrationDate' ? direction : null}
                    onClick={this.sortHandler('registrationDate')}
                  >
                    {this.props.translate('manage-users.registration')}
                  </Table.HeaderCell>
                  <Table.HeaderCell
                    sorted={column === 'lastLogin' ? direction : null}
                    onClick={this.sortHandler('lastLogin')}
                  >
                  ...
                  <Table.Row key={user.publicId} active={user.publicId === this.props.userId}>
                    ...
                    <Table.Cell negative={!user.lastLogin}>
                      {user.lastLogin
                        ...
                        : this.props.translate('manage-users.last-login-never')}
                    </Table.Cell>
