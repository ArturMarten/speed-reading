              ...
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.HeaderCell
                    ...
                    onClick={this.sortHandler('message')}
                  >
                    {this.props.translate('manage-feedback.message')}
                  </Table.HeaderCell>
                  <Table.HeaderCell collapsing>{this.props.translate('manage-feedback.rating')}</Table.HeaderCell>
                </Table.Row>
              </Table.Header>
              <Table.Body>
                {sortedFeedback.map((feedback) => (
                  <Table.Row key={feedback.id}>
                    ...
                    <Table.Cell warning={!feedback.userId}>
                      {feedback.userId ? (
                        this.getUserEmailById(feedback.userId)
                      ) : (
                        <Fragment>{this.props.translate('manage-feedback.user-anonymous')}</Fragment>
                      )}
                    </Table.Cell>
                    ...
                    <Table.Cell>
                      ...
                      <Rating disabled icon="star" rating={feedback.functionalityRating} maxRating={5} />
                      <div>
                        <b>{this.props.translate('manage-feedback.usability-rating')}</b>
                      </div>
                      <Rating disabled icon="star" rating={feedback.usabilityRating} maxRating={5} />
                      <div>
                        <b>{this.props.translate('manage-feedback.design-rating')}</b>
                      </div>
                      <Rating disabled icon="star" rating={feedback.designRating} maxRating={5} />
                    </Table.Cell>
                  </Table.Row>
                ))}
              </Table.Body>
