          ...
          <Grid stackable>
            <Grid.Row verticalAlign="middle" textAlign="center">
              ...
              <Grid.Column width={12}>
                ...
                <div>
                  <b>{`${this.props.translate('about.developer')}: `}</b>
                  {this.props.translate('about.developer-name')}
                </div>
                <div>
                  <b>{`${this.props.translate('about.contributed-creatively')}: `}</b>
                  {this.props.translate('about.contributed-creatively-names')}
                </div>
                <div>
                  <b>{`${this.props.translate('about.contributed-texts')}: `}</b>
                  {this.props.translate('about.contributed-texts-names')}
                </div>
                <br />
                <div>
                  <b>{`${this.props.translate('about.place')} ${new Date().getFullYear()}`}</b>
