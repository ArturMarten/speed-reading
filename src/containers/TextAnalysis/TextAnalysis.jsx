  ...
  */
  ...
  render() {
    ...
    return this.props.open ? (
      <Modal open={this.props.open} onClose={this.props.onClose} closeIcon closeOnDimmerClick={false}>
        ...
        <Modal.Content>
              ...
              <Statistic>
                <Statistic.Value>
                  {this.props.analyzeStatus.loading ? (
                    ...
                    this.props.analysis.characterCount
                  )}
                </Statistic.Value>
                <Statistic.Label>{this.props.translate('text-analysis.characters')}</Statistic.Label>
              </Statistic>
              <Statistic>
                <Statistic.Value>
                  {this.props.analyzeStatus.loading ? <Icon loading name="spinner" /> : this.props.analysis.wordCount}
                </Statistic.Value>
                <Statistic.Label>{this.props.translate('text-analysis.words')}</Statistic.Label>
              </Statistic>
              <Statistic>
                <Statistic.Value>
                  {this.props.analyzeStatus.loading ? (
                    ...
                    this.props.analysis.sentenceCount
                  )}
                </Statistic.Value>
                <Statistic.Label>{this.props.translate('text-analysis.sentences')}</Statistic.Label>
              </Statistic>
            </Statistic.Group>
          </Segment>
          <Segment>
            ...
            <Statistic.Group size="small" widths={2}>
              ...
              <Statistic size="small">
                <Statistic.Label>{this.props.translate('text-analysis.average-word-length')}</Statistic.Label>
                <Statistic.Value>
                  {this.props.analyzeStatus.loading ? (
                    <Icon loading name="spinner" />
                  ) : (
                    this.props.analysis.averageWordLength.toFixed(2)
                  )}
                </Statistic.Value>
                <Statistic.Label>{this.props.translate('text-analysis.characters')}</Statistic.Label>
              </Statistic>
              <Statistic size="small">
                ...
                <Statistic.Label>{this.props.translate('text-analysis.class-rating')}</Statistic.Label>
              </Statistic>
            </Statistic.Group>
          ...
          <Segment>
            ...
            <Statistic.Group widths={3} size="small">
              ...
              <Statistic size="small">
                <Statistic.Label>{this.props.translate('text-analysis.average-sentence-length')}</Statistic.Label>
                <Statistic.Value>
                  {this.props.analyzeStatus.loading ? (
                    <Icon loading name="spinner" />
                  ) : (
