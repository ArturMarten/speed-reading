...
const ExerciseReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case EXERCISE_OPTIONS_UPDATED: {
      const wordGroups = state.exerciseOptions.characterCount === action.payload.characterCount ? state.wordGroups : splitIntoWordGroups(text, action.payload.characterCount);
      return {
        ...state,
