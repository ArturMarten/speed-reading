...
export const fetchTestEditorQuestions = (readingTextId) =>
  new Promise((resolve, reject) => {
    axios
      .get(`/questions?readingTextId=${readingTextId}&embed=answers.correct`)
      .then(
        (response) => {
...
export const changeQuestion = ({ questionId, questionData }) =>
  new Promise((resolve, reject) => {
    axios
      .put(`/questions/${questionId}`, questionData)
      .then(
        (response) => {
...
export const changeAnswer = ({ answerId, answerData }) =>
  new Promise((resolve, reject) => {
    axios
      .put(`/answers/${answerId}`, answerData)
      .then(
        (response) => {
          resolve(serverSuccessMessage(response));
        },
...
export const prepareQuestionTest = (readingTextId) =>
  new Promise((resolve, reject) => {
    axios
      .get(`/questions?readingTextId=${readingTextId}`)
      .then(
        (response) => {
          resolve(response.data);
        },
...
export const prepareBlankTest = (text) =>
  new Promise((resolve, reject) => {
    axios
      .post('/generateBlankExercises', { text })
      .then(
        (response) => {
          resolve(response.data);
        },
...
export const finishQuestionTest = ({ attemptId, answers, result }) =>
  new Promise((resolve, reject) => {
    axios
      .post('/testQuestionAnswers', answers)
      .then(
...
export const fetchTestQuestionAnswers = (testAttemptId) =>
  new Promise((resolve, reject) => {
    axios
      .get(`/testQuestionAnswers?testAttemptId=${testAttemptId}`)
      .then(
        (response) => {
          resolve(response.data);
        },
...
export const fetchTestBlankAnswers = (testAttemptId) =>
  new Promise((resolve, reject) => {
    axios
      .get(`/testBlankAnswers?testAttemptId=${testAttemptId}`)
      .then(
        (response) => {
          resolve(response.data);
        },
...
export const changeTestBlankAnswer = ({ blankAnswerId, userEvaluation }) =>
  new Promise((resolve, reject) => {
    axios
      .patch(`/testBlankAnswers/${blankAnswerId}`, { userEvaluation })
      .then(
        () => {
          resolve();
        },
...
export const reevaluateTestAttempt = ({ testAttemptId }) =>
  new Promise((resolve, reject) => {
    axios
      .patch(`/testAttempts/${testAttemptId}/re-evaluate`)
      .then(
        (response) => {
          resolve(response.data);
        },
